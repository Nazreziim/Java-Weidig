package beispiele.pane.splitPane;
...
public class SplitPaneDemo extends JFrame {
  private static final long serialVersionUID = 6715065277390567945L;

  public SplitPaneDemo() {
    this( "" );
  }

  public SplitPaneDemo( String name ) {
    super( name );
    this.setDefaultCloseOperation( DISPOSE_ON_CLOSE );
    JSplitPane splitPane = new JSplitPane( JSplitPane.VERTICAL_SPLIT, createTableDemo(),
            createListDemo() );
    this.add( splitPane );
    this.pack();
