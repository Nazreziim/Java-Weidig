    ...
    if ( args.length == 1 ) {
      ...
      try {
        ...
        while ( !connected ) {
          ...
          System.out.println( "Server " + serverName.trim() + " on " + serverAddr.getHostAddress()
                  + ":" + serverPort + " is availlable." );
      ...
      System.err.println( "Usage: java chat.simple.clientNamed.Main <Name>" );
    }
  }
}
