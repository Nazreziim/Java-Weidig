...
public class HilfsMeth {    
	...
	public static byte readByte(String abfrage) {
		...
		// Ueber die Kommandozeile einzugeben, liest diese ein und gibt
		// sie als Integerwert zurueck.
	...
	public static long readLong(String abfrage) {
		...
		// Ueber die Kommandozeile einzugeben, liest diese ein und gibt
		// sie als long-Integerwert zurueck.
	...
	public static boolean readBoolean(String abfrage) {
		...
		// Ueber die Kommandozeile einzugeben, liest diesen ein und gibt
		// ihn als Integerwert zurueck.
