...
class Punkt {
	...
	public static void main(String[] args) {
		...
		// Nutzung Konstruktor, der sich auf anderen konstzruktor abstützt
		...
		//Nutzung einer Methode, die sich auf eine andere Methode abstützt und eine Objektreferenz als Parameter nutzt
		p3.verschiebeUm(p2);		
		System.out.println(p3.getX());
		System.out.println(p3.getY());
		...
		//Nutzung einer Objektrefernez in zwei Variablen
