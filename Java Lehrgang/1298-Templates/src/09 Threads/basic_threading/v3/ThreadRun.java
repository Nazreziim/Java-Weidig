 ...
 * 
 * Version 3: Thread implementiert selbst Runnable. Warum nicht von Thread
 * ableiten, dieser
...
public class ThreadRun extends Thread{
	...
	public void run(){
		for(int i = 0; i<100; i++){
			count++;
			System.out.println("Thread Nr. "+this.id+ " zählt "
                                +count);
			try {
		...
		//By the way: jetzt ist der Thread fertig und wird anschließend
                //zerstört
	}
}
