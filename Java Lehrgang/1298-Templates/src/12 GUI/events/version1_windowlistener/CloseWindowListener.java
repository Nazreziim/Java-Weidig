package events.version1_windowlistener;
...
/**
 * Diese Klasse soll zeigen, wie man einen Listener implementiert. Hier ist der Listener auch gleich Event-Quelle, nämlich
 * ein JFrame. Damit müssen alle Methode von WindowListener implementiert werden.
 * Vorteile: - alle Attribute der Quelle sind direkt greifbar. 
 * Nachteil: - eigene Klasse als Listener ist bei größeren Projekten greifbarer
 * @author LGerhard
 *
 */
public class CloseWindowListener extends JFrame implements WindowListener {
	...
	public CloseWindowListener(){
		...
		//Listener für Window-Events anmelden, hier ist es das Objekt selbst, kann aber auch ein anderes Objekt sein
	...
	/*
	 * Folgend die Methoden aus WindowListener. Jeder, der WindowListener sein möchte, muß diese Methoden implementieren.
	 * Wir implementieren alle mit leeren Rumpf, außer windowClosing. 
	 */
	...
	public void windowClosing(WindowEvent e) {
		...
		this.add(l);
		//Bei Änderung eines Frames nach dem Anzeigen, muss validate ausgeführt werden, damit Layout angepasst/ neu berechnet wird. 
		...
		System.exit(0);
		//dispose gibt die zugeordneten Windows-Ressourcen frei und entfernt das Fenster aus der Owner-Child-Registrierung
		//this.dispose();
	}
