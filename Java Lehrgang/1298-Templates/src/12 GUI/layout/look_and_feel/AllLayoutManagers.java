...
/**
 * Eine Klasse mit der sich die unterschiedlichen Layout-Manager von Swing
 * betrachten lassen
 * @author LGerhard
 */
    ...
    private JPanel genCardLayoutPanel() {  	
        ...
        cb.addItemListener(new ItemListener() {
			...
			public void itemStateChanged(ItemEvent e) {
				...
				JPanel cardsPanel = ((JPanel)(((JComboBox)e.getSource()).getParent().getComponent(1)));
