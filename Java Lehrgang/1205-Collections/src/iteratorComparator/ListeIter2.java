...
public class ListeIter2 implements Iterable<Integer> {
	private ListenElement start;
	
	// innere Klasse: Mitgliedsklasse/ Elementklasse Buch Seite 606
	public class IteratorInteger implements Iterator<Integer>, Iterable<Integer>{
		// fuer Iterator-Implementierung
		private ListenElement current;
		
		@Override
		public Iterator<Integer> iterator() {
			this.current = ListeIter2.this.start;
			return this;
		}
	...
	@Override
	public ListeIter2 clone(){
		ListenElement hilf = this.start;		
		ListeIter2 liste = new ListeIter2();
