package events.games.snake.logic;
...
/**
 * The class that encapsulates the star of the show. Basically it stores it's current state and
 * stuff like position, velocity, length and so on.
 *
...
public class Snake {
  ...
  /**
   * The constructor the snake. It takes the initial point, for the head and the Grid that it lives
   * (and dies) in.
   *
  ...
  /**
   * This method is called after food has been consumed. It increases the length of the snake by
   * one.
   *
