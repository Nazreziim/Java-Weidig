package day8.p1c.extendedcontrols;
...
public class TreeTableViewDemo extends Application {
  ...
  public void start( Stage primaryStage ) throws Exception {
    ...
    vornameCol.setCellValueFactory( new TreeItemPropertyValueFactory< Person, String >( "vorname" ) );
    TreeTableColumn< Person, String > nameCol = new TreeTableColumn<>( "Name" );
    nameCol.setCellValueFactory( new TreeItemPropertyValueFactory< Person, String >( "name" ) );
    ...
    gebCol.setCellValueFactory( new TreeItemPropertyValueFactory< Person, LocalDate >( "gebDatum" ) );
    TreeTableColumn< Person, Boolean > verheiratetCol = new TreeTableColumn<>( "verheiratet" );
    verheiratetCol.setCellValueFactory( new TreeItemPropertyValueFactory< Person, Boolean >( "verheiratet" ) );
    ...
    Thread t = new Thread( new Runnable() {
      ...
      public void run() {
        ...
        personList.get( 0 ).setName( "SUPER" );
      }
    } );
    t.start();
