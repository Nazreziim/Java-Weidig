...
public class TableViewDemo extends Application {
  ...
  public void start( Stage primaryStage ) throws Exception {
    ...
    gebCol.setCellValueFactory( new PropertyValueFactory< Person, LocalDate >( "gebDatum" ) );
    TableColumn< Person, Boolean > verheiratetCol = new TableColumn<>( "verheiratet" );
    verheiratetCol.setCellValueFactory( new PropertyValueFactory< Person, Boolean >( "verheiratet" ) );

    TableView< Person > tableView = new TableView<>();
    tableView.getColumns().addAll( idCol, vornameCol, nameCol, emailCol, gebCol, verheiratetCol );
