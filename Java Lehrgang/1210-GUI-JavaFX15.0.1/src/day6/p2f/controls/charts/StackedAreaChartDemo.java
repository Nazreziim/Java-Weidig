package day6.p2f.controls.charts;
 ...
 * categories for every series. The area below the lines connecting the symbols is filled. The
 * various series are stacked above each other. Used for displaying information of numerical scales.
 */
public class StackedAreaChartDemo extends Application {
  ...
  public Parent createContent() {
    ...
    ObservableList< XYChart.Series > stackedAreaChartData = FXCollections.observableArrayList( //
    ...
    chart = new StackedAreaChart( xAxis, yAxis, stackedAreaChartData );
    return chart;
  }
